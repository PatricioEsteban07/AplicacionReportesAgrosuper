...
/**
 * Clase encargada de la importación de CSV para la tabla N3.
 * @author Patricio
 */
public class CSVImport_N3 extends CSVImport
{

    public CSVImport_N3(LocalDB db, String fileDir, String fileName)
    {
        super(db, 8);
