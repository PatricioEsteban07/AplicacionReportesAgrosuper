...
/**
 * Clase encargada de la importación de CSV para la tabla N2.
 * @author Patricio
 */
public class CSVImport_N2 extends CSVImport
{

    public CSVImport_N2(LocalDB db, String fileDir, String fileName)
    {
        super(db, 8);
